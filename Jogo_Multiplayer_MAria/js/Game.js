class Game {
  ...
  start() {
    ...
    // Adicionar sprite de combustível ao jogo
    this.addSprites(fuels, 4, fuelImg, 0.02);

    // Adicionar sprite de moeda ao jogo
    this.addSprites(coins, 18, coinImg, 0.09);

    // Adicionar sprite do obstáculo ao jogo
    this.addSprites(obstacle, obstaclesPositions.length, obstacle1Img, 0.04, obstaclesPositions);
